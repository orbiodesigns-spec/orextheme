...
import AdminInstallationVideos from './pages/admin/AdminInstallationVideos';
...
const AppRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/installation" element={<InstallationGuide user={user} onLoginClick={() => navigate('/login')} />} />

      <Route path="/downloads" element={
        <ProtectedRoute user={user}>
          <DownloadsPage user={user!} onLogout={handleLogout} />
        </ProtectedRoute>
      } />

      <Route path="/changelogs" element={
        <ChangelogPage user={user} onLogout={handleLogout} onLoginClick={() => navigate('/login')} />
      } />

      <Route path="/privacy" element={<PrivacyPolicy user={user} onLoginClick={() => navigate('/login')} />} />
      <Route path="/terms" element={<TermsOfService user={user} onLoginClick={() => navigate('/login')} />} />
      ...
      <Route path="/admin" element={
        ...
        <Route path="changelogs" element={<AdminChangelogsPage token={adminToken!} />} />

        <Route path="support" element={<AdminSupportPage token={adminToken!} />} />
        <Route path="settings" element={<AdminSettings token={adminToken!} />} />
        <Route path="installation-videos" element={<AdminInstallationVideos token={adminToken!} />} />
      </Route>
