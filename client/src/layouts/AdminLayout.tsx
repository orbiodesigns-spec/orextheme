...
import { LayoutDashboard, Users, CreditCard, Layers, MessageSquare, LogOut, Tag, Package, DollarSign, FileText, Settings } from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ onLogout }) => {
    ...
    const menuItems = [
        ...
        { icon: LayoutDashboard, label: 'Installation', path: '/admin/installation-videos' },
        { icon: FileText, label: 'Changelogs', path: '/admin/changelogs' },
