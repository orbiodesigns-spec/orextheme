...
export interface ThemeConfig {
  ...
  previewBgScale?: number;
  previewBgPositionX?: number;
  previewBgPositionY?: number;
  ...
  glassPanelLeftColor: string;
  glassPanelRightColor: string;
  ...
  // Mandala Controls
  mandalaOpacity?: string | number;
  mandalaSpeed?: string | number;
}
...
export const DEFAULT_THEME: ThemeConfig = {
  ...
  accentColor: '#fb923c',
  backgroundColor: '#090f31',
  chromaKeyImage: '',
  previewBgScale: 1,
  previewBgPositionX: 50,
  previewBgPositionY: 50,
  previewBgBlur: 0,
  ...
  glassPanelLeftColor: 'rgba(255, 255, 255, 0.7)',
  glassPanelRightColor: 'rgba(255, 255, 255, 0.7)',
