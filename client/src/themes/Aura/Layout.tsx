...
const Layout: React.FC<Props> = ({ theme }) => {
    ...
    return (
        <div className={styles.container} style={{ backgroundColor: theme.backgroundColor ?? '#0b0c12' }}>
            ...
            <div className={`${styles.circleContainer} ${styles.circleLeft}`}>
                ...
                <svg className={`${styles.ringSvg} ${styles.animateRing}`} viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="46" fill="none" stroke={theme.ringColor} strokeWidth="4" strokeDasharray="40 100" strokeOpacity="1" />
                </svg>
            </div>
