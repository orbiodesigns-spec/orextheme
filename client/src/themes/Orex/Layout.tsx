...
const Layout: React.FC<Props> = ({ theme }) => {
    ...
    return (
        <div className={styles.container} style={{ backgroundColor: theme.backgroundColor ?? '#090f31' }}>
            ...
            <div>
                <img
                    ...
                    style={{
                        opacity: theme.mandalaOpacity ?? 0.2,
                        animationDuration: `${theme.mandalaSpeed ?? 10}s`
                    }}
                />
            </div>
            <div
            ...
            <div className={styles.headerLeft}>
                <div
                    ...
                    <div className={styles.glassPanelLeft} style={{ color: theme.glassPanelLeftColor }}>{theme.glassPanelLeftText}</div>
                </div>
            </div>
            ...
            <div className={styles.headerRight}>
                ...
                >
                    ...
                    <div className={styles.glassPanelRight} style={{ color: theme.glassPanelRightColor }}>{theme.glassPanelRightText}</div>
                </div>
            </div>
            ...
            <div className={styles.chromaArea}>
                {theme.chromaKeyImage ? (
                    <img
                        src={theme.chromaKeyImage}
                        alt="Preview Background"
                        className={styles.chromaImage}
                        style={{
                            transform: `scale(${theme.previewBgScale ?? 1})`,
                            objectPosition: `${theme.previewBgPositionX ?? 50}% ${theme.previewBgPositionY ?? 50}%`,
                            filter: `blur(${theme.previewBgBlur ?? 0}px)`
                        }}
                    />
                ) : (
