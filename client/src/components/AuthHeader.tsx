    ...
    return (
        <nav className="h-16 border-b border-white/5 bg-black/50 backdrop-blur px-6 flex items-center justify-between sticky top-0 z-40">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:flex items-center gap-6">
                ...
                <button onClick={() => navigate('/downloads')} className="text-sm font-medium text-gray-400 hover:text-white transition-colors">Downloads</button>
                <button onClick={() => navigate('/changelogs')} className="text-sm font-medium text-gray-400 hover:text-white transition-colors">Changelogs</button>
                ...
                <button onClick={() => navigate('/installation')} className="text-sm font-medium text-gray-400 hover:text-white transition-colors">Installation</button>
            </div>
