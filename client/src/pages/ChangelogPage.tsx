...
const ChangelogPage: React.FC<ChangelogPageProps> = ({ user, onLogout, onLoginClick }) => {
    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-white font-sans flex flex-col pt-32">
            <Navbar currentPage="changelogs" onLoginClick={onLoginClick} user={user} />
