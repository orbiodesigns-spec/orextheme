...
const EditorPage: React.FC<Props> = ({ user, onUserUpdate, onLogout }) => {
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-blue-500 selection:text-white font-sans pt-24 pb-24 relative overflow-hidden flex flex-col">
            <Navbar user={user} onLoginClick={() => { }} />

            <div className="flex-1 flex overflow-hidden">

                {/* Top Bar - Start below Navbar */}
                <div className="fixed top-28 left-4 right-4 z-40 flex justify-between pointer-events-none">
                    <button
                ...
                <div
                    className="flex-1 flex items-center justify-center transition-all duration-500 overflow-auto"
                    style={{ paddingRight: isEditorOpen ? '340px' : '0' }}
                >
