...
const Dashboard: React.FC<Props> = ({ user, onLogout, onSelectLayout, onUserUpdate }) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-500 selection:text-white font-sans pb-24 relative overflow-hidden">
      {/* Unified Navbar */}
      <Navbar user={user} onLoginClick={() => navigate('/login')} currentPage="dashboard" />

      {/* Ambient Background */}
      <header className="pt-32 pb-12 px-6 text-center border-b border-white/5 bg-gradient-to-b from-blue-900/10 to-transparent">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-8">
        ...
        <h2 className="text-2xl font-bold mb-6">Theme Layouts</h2>
