...
async function main() {
    console.log("--- Registering Aura Theme ---");
    ...
    try {
        const id = 'aura';
        const name = 'Aura Theme';
        const description = 'A dynamic dark theme with vibrant energy for modern broadcasts.';
        // Using a gradient similar to the theme colors
        const thumbnail_url = 'linear-gradient(135deg, #27272a 0%, #ef4444 100%)';
        const is_active = true;
        const display_order = 5; // Ensure it appears after others
        ...
        console.log(`✅ Success! Aura Layout registered/updated.`);
        console.log(result);
